...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 GABA /Users/ruxi/Documents/python/pyNeuroML-master/examples/files_nml/teste9nov2020/hocfiles/x86_64/GABA.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=GABA type=expTwoSynapse)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/ruxi/Documents/python/pyNeuroML-master/examples/files_nml/teste9nov2020/hocfiles/GABA.mod";
static const char* nmodl_file_text = 
  "TITLE Mod file for component: Component(id=GABA type=expTwoSynapse)\n"
  "\n"
  "COMMENT\n"
  "\n"
  ...
  "NET_RECEIVE(weight) {\n"
  "    \n"
  "    : paramMappings . : {GABA={A=A, B=B, tauRise=tauRise, tauDecay=tauDecay, peakTime=peakTime, waveformFactor=waveformFactor, gbase=gbase, erev=erev, g=g, i=i}}\n"
  "    : state_discontinuity(A, A  + (weight *   waveformFactor  )) : From GABA\n"
  "    A = A  + (weight *   waveformFactor  ) : From GABA\n"
  "    \n"
  "    : paramMappings . : {GABA={A=A, B=B, tauRise=tauRise, tauDecay=tauDecay, peakTime=peakTime, waveformFactor=waveformFactor, gbase=gbase, erev=erev, g=g, i=i}}\n"
  "    : state_discontinuity(B, B  + (weight *   waveformFactor  )) : From GABA\n"
  "    B = B  + (weight *   waveformFactor  ) : From GABA\n"
  "    \n"
  "}\n"
  "\n"
  "DERIVATIVE states {\n"
