...
def main():
    ...
    parser.add_argument('-hidden_size', type=int, default=56)
    ...
    saveplace = ['Experiment1/RNN/56/Run1/', 'Experiment1/RNN/56/Run2/', 'Experiment1/RNN/56/Run3/', 'Experiment1/RNN/56/Run4/',
    'Experiment1/RNN/56/Run5/', 'Experiment1/RNN/56/Run6/', 'Experiment1/RNN/56/Run7/', 'Experiment1/RNN/56/Run8/',
    'Experiment1/RNN/56/Run9/', 'Experiment1/RNN/56/Run10/']
