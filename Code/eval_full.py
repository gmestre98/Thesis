...
def plotresults(opt, real, predicted, folder, string, path, out_size):
    ...
    'RMED_Predicted', 'RMEL_Predicted', 'RMER_Predicted', 'RMEV_Predicted', 'RMGL_Predicted', 'RMGR_Predicted',
    'RMHL_Predicted', 'RMHR_Predicted', 'SMDDL_Predicted', 'SMDDR_Predicted', 'SMDVL_Predicted', 'SMDVR_Predicted']
...
def main():
    ...
    parser.add_argument('-savepath', type=str, default="Experiment4/GRU-32/Run10/")
